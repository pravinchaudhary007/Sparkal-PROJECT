...
const SliderBar = () => {
  ...
  const { msg, title, path } = items[currentIndex];
  ...
  return (
    <section className='relative w-full lg:h-[520px] md:h-[450px] sm:h-[400px] h-44 select-none overflow-hidden bg-line bg-cover bg-center bg-no-repeat'>
      ...
      <div className='absolute inset-0 bg-[#dbd2b7] transform rotate-[-5deg] origin-top-left -left-14'>
        ...
        {/* Slider content box */}
        <article className='lg:h-96 lg:w-96 md:h-80 md:w-80 sm:h-60 sm:w-60 h-28 w-28 bg-white md:p-3 sm:p-2 p-1 lg:right-52 lg:-bottom-12 md:right-36 md:-bottom-8 
